...
public meta import CompPoly.Fields.BLS12_377.Fast

/-!
# Fast BLS12-377 Scalar Field Tests
...
agreement with the canonical `BLS12_377.ScalarField` model through `toField`.
-/
...
#guard ((scalarFieldSize - 1 : ScalarField).invGcd).toField
  = ((scalarFieldSize - 1 : BLS12_377.ScalarField)⁻¹)
